...
<div class="modal-dialog modal-dialog-centered modal-l ">
    <div class="modal-content">
        <div class="modal-header ">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                <li class="nav-item d-flex justify-content-center" role="presentation"
                    style="width: 228px;">
                    <button class="nav-link active w-100" id="pills-dn-tab"
                        data-bs-toggle="pill" data-bs-target="#pills-dn" type="button"
                        role="tab" aria-controls="pills-dn" aria-selected="true">Đăng
                        nhập</button>
                </li>
                <li class="nav-item d-flex justify-content-center" role="presentation"
                    style="width: 228px;">
                    <button class="nut-bt nav-link w-100" id="pills-dk-tab"
                        data-bs-toggle="pill" data-bs-target="#pills-dk" type="button"
                        role="tab" aria-controls="pills-dk" aria-selected="true">Đăng
                        ký</button>
                </li>
            </ul>
        </div>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-dk" role="tabpanel"
                    ...
                    <div class="col-12 mt-1 p-3 ">
                        <h2 class="text-center mb-4">ĐĂNG
                            KÝ TÀI KHOẢN</h2>
                        <p class="text-center mb-4">Tạo
                            tài khoản BÁO TIN
                            TƯC Để sử dụng đầy
                            đủ tính năng đọc báo
                            và tham gia cộng
                            đồng hơn 8 triệu
                            thành viên</p>
                        <div class="duongke row d-flex justify-content-center ">
        ...
        <div
            class="modal-footer d-flex justify-content-center align-items-center text-center">
            <span>Bạn đã đăng nhập hoặc tạo cài
                khoản là đồng ý với
                <a href="#"> điều khoản sử
                    dụng</a> và <a href="#">chính sách
                    bảo mật</a> của BÁO TIN TỨC
            </span>
        </div>
    </div>
</div>
